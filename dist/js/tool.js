...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Nova.request().get('/nova-vendor/nova-spotify-auth-tool/refresh-token');

              case 2:
                _ref2 = _context.sent;
                this.refreshToken = _ref2.data;
    ...
    requestSpotifyRefreshToken: function requestSpotifyRefreshToken() {
  ...
  return _c(
    ...
    [
        ...
        _c("span", { staticClass: "mb-6" }, [
          _c(
            "button",
            {
              ...
              on: { click: _vm.requestSpotifyRefreshToken }
            },
      ...
      _c("card", { staticClass: "p-4" }, [
        ...
        _vm._v(" "),
        _c("p", { staticStyle: { "overflow-wrap": "break-word" } }, [
          _vm._v("\n      " + _vm._s(_vm.refreshToken) + "\n    ")
        ])
      ])
    ],
    1
